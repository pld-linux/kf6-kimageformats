...
# Source0-md5:	83298804fa3f2754f277ffdd3a87fb05
URL:		https://kde.org/
...
%cmake -B build \
	...
	%{?with_jxr:-DKIMAGEFORMATS_WITH_KNOWN_CRASHES_JXR=ON}
...
%endif
%{qt6dir}/plugins/imageformats/kimg_ff.so
...
%{qt6dir}/plugins/imageformats/kimg_tim.so
